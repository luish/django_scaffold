...
class Command(BaseCommand):
    ...
    def get_project_path(self):
        ...
        path = os.path.dirname(os.path.normpath(settings_file))
    ...
    def create_urls(self, app_path, app_name, klass):
        with open(os.path.join(self.project_path, app_name, 'urls.py'), 'w') as urls_file:
    ...
    def add_appurl_to_urlspy(self, app_name):
        #get project urls.py
        with open(os.path.join(self.project_path, self.project_name, 'urls.py'), 'a') as urlspy_file:
